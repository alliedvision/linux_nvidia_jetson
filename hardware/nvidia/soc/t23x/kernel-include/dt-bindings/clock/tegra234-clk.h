...
#define TEGRA234_MAX_PUBLIC_CLK_ID		476U

/** @} */

/* Alias between CAR clock and IP clock names for client conveniency */
#define TEGRA234_CLK_JTAG_INTFC			TEGRA234_CLK_FUSE
