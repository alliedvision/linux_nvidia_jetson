...
PRODUCT_COPY_FILES += \
    ...
    $(BCT_FILES_PATH)/scr/tegra194-mb1-bct-scr-cbb-mini.cfg:tegra194-mb1-bct-scr-cbb-mini-safety.cfg \
    $(BCT_FILES_PATH)/scr/tegra194-mb1-bct-scr-cbb-mini.cfg:tegra194-mb1-bct-scr-cbb-mini-spi1-to-tz.cfg \
