...
static struct snd_soc_pcm_stream tegra_t210ref_p2382_amx_input_params[] = {
	[0] = {
...
static int tegra_t210ref_p2382_i2s_dai_init(struct snd_soc_pcm_runtime *rtd)
{
	...
	unsigned int mclk, clk_out_rate, srate, bclk_ratio;
