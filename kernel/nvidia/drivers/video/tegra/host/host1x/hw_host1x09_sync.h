 ...
 *         of register <x>.
 */
#ifndef _hw_host1x09_sync_h_
#define _hw_host1x09_sync_h_
...
{
	/* arhost: HOST1X_THOST_COMMON_ILLEGAL_SYNCPT_ACCESS_FRM_CLIENT_0 */
	return 0x4268;
}
...
{
	/* arhost: HOST1X_THOST_COMMON_ILLEGAL_SYNCPT_ACCESS_FRM_PB_0 */
	return 0x4270;
}
...
{
	/* arhost: HOST1X_THOST_CHANNEL_CH0_TEARDOWN_0 */
	return 0x004c;
}
static inline u32 host1x_sync_ctxsw_timeout_cfg_r(void)
{
	/* arhost: HOST1X_THOST_COMMON_CTXSW_TIMEOUT_CFG_0 */
	return 0x42e0;
}
static inline u32 host1x_sync_ip_read_timeout_addr_r(void)
{
	/* arhost: HOST1X_THOST_COMMON_AXIREAD_TIMEOUT_ADDR_0 */
	return 0x4254;
}
static inline u32 host1x_sync_ip_write_timeout_addr_r(void)
{
	/* arhost: HOST1X_THOST_COMMON_AXIWRITE_TIMEOUT_ADDR_0 */
	return 0x425c;
}
...
{
	/* arhost: HOST1X_THOST_COMMON_CH0_CMDFIFO_SETUP_0 */
	return 0x4588;
}
...
{
	/* arhost: HOST1X_THOST_CHANNEL_CH0_CMDFIFO_RDATA_0 */
	return 0x28;
}
static inline u32 host1x_sync_cboffset_r(void)
{
	/* arhost: HOST1X_THOST_CHANNEL_CH0_CMDP_OFFSET_0 */
	return 0x30;
}
static inline u32 host1x_sync_cbclass_r(void)
{
	/* arhost: HOST1X_THOST_CHANNEL_CH0_CMDP_CLASS_0 */
	return 0x34;
}
...
{
	/* arhost: HOST1X_THOST_COMMON_THOST_GLOBAL_SYNCPT_INTRMASK_0 */
	return 0x50;
}
...
{
	/* arhost: HOST1X_THOST_COMMON_THOST_MLOCK_0 */
	return 0x4030;
}
...
{
	/* arhost: HOST1X_THOST_COMMON_ICG_EN_OVERRIDE_0 */
	return 0x4808;
}
...
static inline u32 host1x_common_vm1_syncpt_intr_dest_vm_r(void)
{
	/* arhost: HOST1X_THOST_COMMON_VM1_SYNCPT_INTR_DEST_VM_0 */
	return 0x6644;
}
#endif
