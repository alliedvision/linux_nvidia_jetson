...
const struct rtw_proc_hdl adapter_proc_hdls[] = {
	...
	RTW_PROC_HDL_SSEQ("roam_int", proc_get_roam_param_int, proc_set_roam_param_int),
	RTW_PROC_HDL_SSEQ("roam_tgt_addr", proc_get_roam_tgt_addr, proc_set_roam_tgt_addr),
