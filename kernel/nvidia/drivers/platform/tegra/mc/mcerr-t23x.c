...
#define ERR_GENERALIZED_ADR_HI_SHIFT	16
#define ERR_GENERALIZED_ADR_UPPER_BITS	32
#define ERR_ADR_UPPER_BITS		32
...
static struct mc_client mc_clients[] = {
	...
	client("miu", "csr_miu8r", INVALID),
	client("miu", "csw_miu8w", INVALID),
	client("miu", "csr_miu9r", INVALID),
	client("miu", "csw_miu9w", INVALID),
	client("miu", "csr_miu10r", INVALID),
	client("miu", "csw_miu10w", INVALID),
	client("miu", "csr_miu11r", INVALID),
	client("miu", "csw_miu11w", INVALID),
	client("miu", "csr_miu12r", INVALID),
	client("miu", "csw_miu12w", INVALID),
	client("miu", "csr_miu13r", INVALID),
	client("miu", "csw_miu13w", INVALID),
	client("miu", "csr_miu14r", INVALID),
	client("miu", "csw_miu14w", INVALID),
	client("miu", "csr_miu15r", INVALID),
	client("miu", "csw_miu15w", INVALID),
	client("NA", "csr_nvl5rhp", INVALID),
	client("NA", "csr_nvl5r", INVALID),
	client("hda", "csr_hdar", INVALID),
	client("hc", "csr_host1xdmar", INVALID),
	client("NA", "csw_nvl5w", INVALID),
	client("NA", "csr_nvl6rhp", INVALID),
	client("NA", "csr_nvl6r", INVALID),
	client("NA", "csw_nvl6w", INVALID),
	client("NA", "csr_nvl7rhp", INVALID),
	client("nvenc", "csr_nvencsrd", INVALID),
	client("NA", "csr_nvl7r", INVALID),
	client("NA", "csw_nvl7w", INVALID),
	dummy_client,
	client("NA", "csr_nvl8rhp", INVALID),
	client("NA", "csr_nvl8r", INVALID),
	client("NA", "csw_nvl8w", INVALID),
	client("NA", "csr_nvl9rhp", INVALID),
	client("NA", "csr_nvl9r", INVALID),
	client("NA", "csw_nvl9w", INVALID),
	dummy_client,
	client("mpcore", "csr_mpcorer", INVALID),
	client("pcie6a", "csr_pcie6ar", INVALID),
	client("pcie6a", "csw_pcie6aw", INVALID),
	client("pcie7a", "csr_pcie7ar", INVALID),
	client("nvenc", "csw_nvencswr", INVALID),
	client("dlab", "csr_dla0rdb", INVALID),
	client("dlab", "csr_dla0rdb1", INVALID),
	client("dlaa", "csw_dla0wrb", INVALID),
	client("dla1b", "csr_dla1rdb", INVALID),
	client("pcie7a", "csw_pcie7aw", INVALID),
	dummy_client,
	client("pcie8a", "csr_pcie8ar", INVALID),
	client("psca", "csr_pscr", INVALID),
	client("psca", "csw_pscw", INVALID),
	...
	dummy_client,
	client("pcie8a", "csw_pcie8aw", INVALID),
	client("pcie9a", "csr_pcie9ar", INVALID),
	dummy_client,
	client("pcie9a", "csw_pcie9aw", INVALID),
	client("pcie10a", "csr_pcie10ar", INVALID),
	client("pcie10a", "csw_pcie10aw", INVALID),
	client("ufshcb", "csr_ufshcbr", INVALID),
	client("ufshcb", "csw_ufshcbw", INVALID),
	client("ufshcc", "csr_ufshccr", INVALID),
	...
	client("xspib", "csw_xspi1w", INVALID),
	client("ufshcc", "csw_ufshccw", INVALID),
	client("mgbe0", "csr_mgbeard", INVALID),
	client("mgbe1", "csr_mgbebrd", INVALID),
	client("mgbe2", "csr_mgbecrd", INVALID),
	client("mgbe3", "csr_mgbedrd", INVALID),
	client("mgbe0", "csw_mgbeawr", INVALID),
	client("ofaa", "csr_ofar", INVALID),
	client("ofaa", "csw_ofaw", INVALID),
	client("mgbe1", "csw_mgbebwr", INVALID),
	client("sdmmc1a", "csr_sdmmcra", INVALID),
	client("mgbe2", "csw_mgbecwr", INVALID),
	dummy_client,
	client("sdmmc4a", "csr_sdmmcrab", INVALID),
	client("sdmmc1a", "csw_sdmmcwa", INVALID),
	client("mgbe3", "csw_mgbedwr", INVALID),
	dummy_client,
	client("sdmmc4a", "csw_sdmmcwab", INVALID),
	client("seu1", "csr_seu1rd", INVALID),
	client("seu1", "csw_seu1wr", INVALID),
	client("dce", "csr_dcer", INVALID),
	client("dce", "csw_dcew", INVALID),
	client("vic", "csr_vicsrd", INVALID),
	client("vic", "csw_vicswr", INVALID),
	client("dla1b", "csr_dla1rdb1", INVALID),
	client("dla1b", "csw_dla1wrb", INVALID),
	client("vi3", "csw_vi2w", INVALID),
	client("vi2fal", "csr_vi2falr", INVALID),
	client("vi", "csw_viw", INVALID),
	client("nvdispniso", "csr_nvdispnisor", INVALID),
	client("nvdispniso", "csw_nvdispnisow", INVALID),
	client("xspia", "csr_xspi0r", INVALID),
	client("xspia", "csw_xspi0w", INVALID),
	client("xspib", "csr_xspi1r", INVALID),
	client("nvdec", "csr_nvdecsrd", INVALID),
	client("nvdec", "csw_nvdecswr", INVALID),
	client("ape", "csr_aper", INVALID),
	client("ape", "csw_apew", INVALID),
	client("vi2fal", "csw_vi2falw", INVALID),
	dummy_client,
	...
	client("dcedma", "csr_dcedmar", INVALID),
	client("dcedma", "csw_dcedmaw", INVALID),
	dummy_client,
	dummy_client,
...
enum {
	...
	GIS_CH_MASK = 0xFF,
	GIS_SLICE_MASK = 0xFF00,
	/* Mask for HUB 0-3: HUB group 1(HUBG1) */
	GIS_HUBG1_MASK = 0xF0000, /* Mask for HUB 0-3 */

	GIS_NVLINK_MASK = 0x1F00000,

	/* Mask for HUB 4-7: HUB group 2(HUBG2) */
	GIS_HUBG2_MASK = 0x78000000,
...
static void save_intstatus(unsigned int irq)
{
	...
	if (global_intstatus & GIS_CH_MASK) {
		...
		mc_channel = __ffs((global_intstatus & GIS_SLICE_MASK)
					 >> GIS_SLICE0);
	} else if (global_intstatus & GIS_HUBG1_MASK) {
		mc_channel = __ffs((global_intstatus & GIS_HUBG1_MASK)
					 >> GIS_HUB0);
	} else if (global_intstatus & GIS_NVLINK_MASK) {
		mc_channel = __ffs((global_intstatus & GIS_NVLINK_MASK)
					 >> GIS_nvlink0);
	} else if (global_intstatus & GIS_HUBG2_MASK) {
		mc_channel = __ffs((global_intstatus & GIS_HUBG2_MASK)
					 >> GIS_HUB4);
...
static void log_fault(int src_chan, const struct mc_error *fault)
{
	...
	u32 gsc_status_1 = 0, high_addr_reg = 0;


	if (fault->flags & E_VPR)
		mcerr_pr("vpr base=%x:%x, size=%x, ctrl=%x, override:"
				"(%x, %x, %x, %x)\n",
	...
	if (fault->flags & E_GSC) {
		...
		addr |= ((phys_addr_t)(gsc_status_1 >>
			 ERR_GENERALIZED_ADR_HI_SHIFT) <<
			 ERR_GENERALIZED_ADR_UPPER_BITS);
	} else if (fault->flags & E_ADR_HI_REG) {
		high_addr_reg = __mc_readl(src_chan, fault->addr_hi_reg);
		addr |= ((phys_addr_t)high_addr_reg << ERR_ADR_UPPER_BITS);
	} else {
		addr |= (((phys_addr_t)(status & MC_ERR_STATUS_ADR_HI_BITS))
				 << ERR_GENERALIZED_ADR1_UPPER_BITS);
	}
	...
	if (fault->flags & E_GSC) {
		mcerr_pr("gsc_id=%d, gsc_apr_id=%d gsc_co_apr_id=%d\n",
			(status & ERR_GENERALIZED_ID_MASK),
			((gsc_status_1 >> ERR_GENERALIZED_APERTURE_ID_SHIFT)
			& ERR_GENERALIZED_APERTURE_ID_MASK),
			((gsc_status_1 >>
			ERR_GENERALIZED_CARVEOUT_APERTURE_ID_SHIFT)
...
{
	pr_info("mcerr ops are set to t23x\n");
	return &mcerr_ops;
}

MCERR_OF_DECLARE(mcerr_of, "nvidia,tegra-t23x-mc", t18x_mcerr_of_setup);
