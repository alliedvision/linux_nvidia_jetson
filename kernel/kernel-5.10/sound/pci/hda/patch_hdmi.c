 ...
 *  Copyright (c) 2008-2022 NVIDIA Corp.  All rights reserved.
...
static int patch_tegra_t23x_hdmi(struct hda_codec *codec)
{
	struct hdmi_spec *spec;
	int err;
...
HDA_CODEC_ENTRY(0x10de0031, "Tegra23x HDMI/DP",	patch_tegra_t23x_hdmi),
